                                    ...
                                    {isExpanded && (
                                        <tr className="bg-slate-950/30 shadow-inner">
                                            <td colSpan={6} className="p-6">
                                                    ...
                                                    <div className="bg-muted/40 p-4 rounded-xl border border-border space-y-3">
                                                        ...
                                                        <div className="space-y-1 text-sm">
                                                            ...
                                                            <div className="flex justify-between pt-2 border-t border-border">
                                                                ...
                                                                <span className="text-primary font-bold font-mono">{item.designLoad.toFixed(1)} kg</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div className="space-y-2 text-sm">
                                                            <div className="relative">
                                                                <div className="flex justify-between mb-1">
                                                                    ...
                                                                    <span className={`font-mono text-xs font-bold ${item.utilization > 80 ? 'text-amber-500' : 'text-primary'}`}>
                                                                        {item.utilization.toFixed(1)}%
                                                                    </span>
                                                                </div>
                                                                <div className="h-1.5 w-full bg-secondary rounded-full overflow-hidden">
                                                                    <div
                                                                        className={`h-full rounded-full transition-all ${item.utilization > 100 ? 'bg-destructive' : item.utilization > 80 ? 'bg-amber-500' : 'bg-primary'}`}
                                                    ...
                                                    <div className="bg-muted/40 p-4 rounded-xl border border-border space-y-3">
                                                        ...
                                                        <div className="space-y-1">
                                                            ...
                                                            <div className="text-[10px] text-muted-foreground">
                                                                Recomandare: <span className="text-primary font-bold">{item.anchorReaction > 500 ? 'M12 Hilti HIT' : item.anchorReaction > 200 ? 'M10 Expandabil' : 'M8 Standard'}</span>
                                                            </div>
                                                        </div>

                                                        {/* HEAVY DUTY WARNING TRIGGER */}
                                                        {item.isHeavyDuty && (
                                                            <div className="mt-3 bg-destructive/10 border border-destructive/20 p-2.5 rounded-lg">
                                                                <div className="flex items-center gap-2 text-destructive text-xs font-bold uppercase tracking-wider mb-1.5">
                                                                ...
                                                                <div className="grid grid-cols-2 gap-2 mt-2 text-[10px] font-mono text-white/90">
                                                                    <div className="bg-destructive/40 px-1.5 py-0.5 rounded border border-destructive/30 text-center">
                                                                        M12: 40 Nm
                                                                    </div>
                                                                    <div className="bg-destructive/40 px-1.5 py-0.5 rounded border border-destructive/30 text-center">
                                                                        M16: 95 Nm
                                                ...
                                                <div className="mt-6 bg-muted/60 p-5 rounded-xl border border-primary/20 shadow-lg relative overflow-hidden group">
                                                    ...
                                                    <h4 className="flex items-center gap-2 text-sm font-bold text-primary uppercase tracking-widest mb-3 relative z-10">
                                                ...
                                                {/* Safety Note */}
                                                <div className="mt-4 flex items-start gap-2 text-[10px] text-primary/60 italic bg-primary/5 p-3 rounded-lg border border-primary/10">
