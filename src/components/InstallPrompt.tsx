                    ...
                    <div className="bg-white dark:bg-stone-800 rounded-xl shadow-2xl border border-stone-200 dark:border-stone-700 overflow-hidden">
                        <div className="p-4">
                            <div className="flex items-start gap-3">
                                <div className="shrink-0 w-12 h-12 bg-linear-to-br from-primary/80 to-primary rounded-xl flex items-center justify-center">
                            ...
                            <div className="flex gap-2 mt-4">
                                ...
                                <button
                                    ...
                                    className="flex-1 px-4 py-2 text-sm font-medium text-white bg-primary hover:bg-primary/90 rounded-lg transition-all"
                                >
                                    {t('pwa.install')}
                                </button>
                            </div>
