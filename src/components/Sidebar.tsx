...
const NavSection = ({ title, items, activeTab, onTabChange }: {
    title?: string;
    items: MenuItem[];
    activeTab: string;
        ...
        <aside className="sidebar-panel w-[280px] flex flex-col justify-between p-4 z-50">
            <div className="flex-1 overflow-y-auto no-scrollbar">
                ...
                <button
                    ...
                    className="w-full group flex items-center justify-between p-3 rounded-2xl bg-secondary/30 hover:bg-secondary/50 border border-border/50 transition-all mb-8 backdrop-blur-sm"
                >
