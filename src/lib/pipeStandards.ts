...
export const PIPE_STANDARDS: Record<string, PipeStandard> = {
    ...
    inox_press: {
        ...
        category: 'metal',
        dimensions: [
            { dn: "15mm", inch: "-", od: 15, thickness: 1.0, id: 13.0, weight: 0.35 },
            { dn: "18mm", inch: "-", od: 18, thickness: 1.0, id: 16.0, weight: 0.43 },
            { dn: "22mm", inch: "-", od: 22, thickness: 1.2, id: 19.6, weight: 0.62 },
            { dn: "28mm", inch: "-", od: 28, thickness: 1.2, id: 25.6, weight: 0.80 },
            { dn: "35mm", inch: "-", od: 35, thickness: 1.5, id: 32.0, weight: 1.25 },
            { dn: "42mm", inch: "-", od: 42, thickness: 1.5, id: 39.0, weight: 1.51 },
            { dn: "54mm", inch: "-", od: 54, thickness: 1.5, id: 51.0, weight: 1.96 },
            { dn: "76.1mm", inch: "-", od: 76.1, thickness: 2.0, id: 72.1, weight: 3.70 },
            { dn: "88.9mm", inch: "-", od: 88.9, thickness: 2.0, id: 84.9, weight: 4.33 },
            { dn: "108mm", inch: "-", od: 108, thickness: 2.0, id: 104.0, weight: 5.28 },
        ]
    },
    copper: {
        label: "Cupru (EN 1057)",
        ...
        dimensions: [
            ...
            { dn: "22mm", inch: "-", od: 22, thickness: 0.7, id: 20.6, weight: 0.42 },
            { dn: "28mm", inch: "-", od: 28, thickness: 1.0, id: 26.0, weight: 0.75 },
            { dn: "35mm", inch: "-", od: 35, thickness: 1.0, id: 33.0, weight: 0.95 },
