...
export type TabId = 'dashboard' | 'config' | 'wizard' | 'supports' | 'weights' | 'photos' | 'branding' | 'pipe-standards' | 'bim_gallery' | 'hydraulics' | 'help' | 'settings' | 'normative' | 'architecture_spec';
