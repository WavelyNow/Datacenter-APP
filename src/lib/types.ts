...
export type TabId = 'dashboard' | 'config' | 'supports' | 'weights' | 'photos' | 'branding' | 'catalogs' | 'bim' | 'bim_gallery' | 'energy' | 'costs' | 'checklist' | 'hydraulics' | 'help' | 'boq';
...
// ============================================================================
// Bill of Quantities (BoQ) Module Types
// ============================================================================

export type BoQCategory = 'Mechanical' | 'Electrical' | 'Supports' | 'Consumables' | 'Services';
export type BoQUnit = 'm' | 'pcs' | 'kg' | 'set' | 'lot' | 'L';
export type BoQCurrency = 'EUR' | 'RON' | 'USD';

export interface BoQItem {
    id: string;
    category: BoQCategory;
    code: string; // Article code (e.g., SAP, internal)
    description: string;
    quantity: number;
    unit: BoQUnit;
    unitPrice: number;
